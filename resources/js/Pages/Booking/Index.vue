  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <section class="relative h-[300px] md:h-[400px] lg:h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div class="relative z-20 text-center text-white px-4 max-w-4xl mx-auto">
        ...
        <a
          href="#booking"
          class="inline-block bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 md:py-4 md:px-8 rounded-full text-base md:text-lg transition-all transform hover:scale-105 shadow-lg"
        >
          Book Now
        </a>
      </div>
      ...
      <div class="max-w-6xl mx-auto px-4">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div class="text-center p-4 md:p-6">
            ...
            <h3 class="text-lg md:text-xl font-bold mb-2">Thrilling Adventure</h3>
            <p class="text-gray-600 text-sm md:text-base">Navigate through exciting rapids with our expert guides</p>
          </div>
          <div class="text-center p-4 md:p-6">
            <div class="w-12 h-12 md:w-16 md:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
              <svg class="w-6 h-6 md:w-8 md:h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="text-lg md:text-xl font-bold mb-2">Safe & Professional</h3>
            <p class="text-gray-600 text-sm md:text-base">Certified guides and top-quality safety equipment</p>
          </div>
          <div class="text-center p-4 md:p-6">
            <div class="w-12 h-12 md:w-16 md:h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3 md:mb-4">
              <svg class="w-6 h-6 md:w-8 md:h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <h3 class="text-lg md:text-xl font-bold mb-2">Flexible Times</h3>
            <p class="text-gray-600 text-sm md:text-base">Multiple departure times to fit your schedule</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="booking" class="py-12 md:py-20 bg-gradient-to-br from-blue-50 to-blue-100">
      <div class="max-w-4xl mx-auto px-4">
        <div class="text-center mb-8 md:mb-12">
          <h2 class="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Book Your Rafting Trip</h2>
          <p class="text-base md:text-xl text-gray-600">Choose your preferred date and time</p>
        </div>
        ...
        <div class="bg-white rounded-xl md:rounded-2xl shadow-xl p-4 md:p-8">
          <form @submit.prevent="submitBooking">
            ...
            <!-- Number of People -->
            <div v-if="selectedSlot" class="mb-6 md:mb-8">
            ...
            <!-- Customer Info -->
            <div v-if="selectedSlot" class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6 md:mb-8">
              <div>
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                ...
                >
                  ...
                  <div class="flex items-center">
                    <svg class="w-5 h-5 md:w-6 md:h-6 text-blue-600 mr-2 md:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" />
                    </svg>
                    <div>
                      <div class="font-semibold text-sm md:text-base">Pay Online</div>
                      <div class="text-xs md:text-sm text-gray-600">Pay now with Stripe</div>
                    </div>
                  </div>
                </label>
                <label
                ...
                >
                  ...
                  <div class="flex items-center">
                    ...
                    <div>
                      <div class="font-semibold text-sm md:text-base">Pay at Site</div>
                      <div class="text-xs md:text-sm text-gray-600">Pay when you arrive</div>
                    </div>
                  </div>
                </label>
              </div>
            ...
            <div v-if="selectedSlot" class="bg-gray-50 rounded-lg p-4 md:p-6 mb-6 md:mb-8">
              ...
              <div class="flex justify-between items-center pt-2 border-t border-gray-200">
                ...
                <span class="font-bold text-xl md:text-2xl text-blue-600">₹{{ totalPrice.toFixed(2) }}</span>
              </div>
            </div>
            ...
            <button
              ...
              class="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-bold py-3 md:py-4 px-6 md:px-8 rounded-lg text-base md:text-lg transition-all transform hover:scale-[1.02] shadow-lg"
            >
    ...
    <!-- Gallery Section -->
    <section v-if="galleryImages.length > 0" class="py-12 md:py-20 bg-white">
      <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-8 md:mb-12">
          <h2 class="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Photo Gallery</h2>
          <p class="text-base md:text-xl text-gray-600">Relive the adventure through our photos</p>
        </div>
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 md:gap-4">
          ...
          >
            ...
            <p class="py-2 md:py-5 text-xs md:text-sm text-center text-gray-700">{{image.title}}</p>
    ...
    <section v-if="testimonials.length > 0" class="py-12 md:py-20 bg-blue-50">
      <div class="max-w-6xl mx-auto px-4">
        <div class="text-center mb-8 md:mb-12">
          <h2 class="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">What Our Customers Say</h2>
          <p class="text-base md:text-xl text-gray-600">Real experiences from real adventurers</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          <div
            v-for="testimonial in testimonials"
            :key="testimonial.id"
            class="bg-white rounded-xl p-4 md:p-6 shadow-md"
          >
            <div class="flex items-center mb-3 md:mb-4">
              <div class="w-10 h-10 md:w-12 md:h-12 bg-blue-100 rounded-full flex items-center justify-center">
                <span class="text-blue-600 font-bold text-base md:text-lg">{{ testimonial.customer_name.charAt(0) }}</span>
              </div>
              <div class="ml-3 md:ml-4">
                <div class="font-semibold text-sm md:text-base">{{ testimonial.customer_name }}</div>
                <div class="text-yellow-400 text-sm">{{ '★'.repeat(testimonial.rating) }}</div>
              </div>
            </div>
            <p class="text-gray-600 text-sm md:text-base italic">"{{ testimonial.comment }}"</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section id="contact" class="py-12 md:py-20 bg-white">
      <div class="max-w-4xl mx-auto px-4">
        <div class="text-center mb-8 md:mb-12">
          <h2 class="text-2xl md:text-4xl font-bold text-gray-900 mb-3 md:mb-4">Contact Us</h2>
          <p class="text-base md:text-xl text-gray-600">Have questions? We'd love to hear from you!</p>
        </div>
